		...
		<tbody>  
			...
			<tr> 
				...
				<td>
					...
					<a href="hapus_brg_keluar.php?id_brg_keluar=<?php echo $baris['id_brg_keluar']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Mau Dihapus ?')"><i class="fa fa-trash-o"></i></a>
			</tr> 
