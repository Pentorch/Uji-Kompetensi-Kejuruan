		...
		<tbody>  
			...
			<tr> 
				...
				<td>
					...
					<a href="hapus_pinjaman.php?id_pinjam=<?php echo $baris['id_pinjam']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Mau Dihapus ?')"><i class="fa fa-trash-o"></i></a>
				</td> 
