...
<div class="panel-body">              
	<div class="well"> 
		<div id="print-area-2"> <center> 
			...
			<img src="../img/garis.png" width="1000"></h3> <h2 class="page-header" id="print-area-2">Laporan Data Barang Keluar</h2> <table class="table table-striped table-bordered table-hover"  border="1"> 
				<tr align="center"> 
					<th >No</th> 
					<th>Nama Barang</th> 
