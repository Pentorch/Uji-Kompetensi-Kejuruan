...
<h3 class="page-header">Tambah Data Peminjam</h3> 
    ...
    <div class="col-lg-6">
     ...
     <div class="form-group">                 
              ...
              <input class="form-control" type="date" name="tgl_pinjam" placeholder="Masukan Tanggal Pinjam Barang Ex: yyyy-mm-dd">        
              </div> 
    ...
    <div class="form-group">                 
              ...
              <input class="form-control" type="date" name="tgl_kembali" placeholder="Masukan Tanggal pengembalian barang Ex: yyyy-mm-dd">        
              </div>          
