	  			 ...
	  			 <form role="form" action="" method="POST">               
	   				<input  type="text" name="id_pinjam" value="<?php echo $res['id_pinjam'] ?>" hidden>
	    				...
	    				<div class="form-group">                 
        					...
        					<input class="form-control" type="text" name="tgl_pinjam" id="tanggal" value="<?php echo $res['tgl_pinjam'] ?>">           
      					</div>              
	                ...
	                <div class="col-lg-6">             
	                	<div class="form-group">                 
	                		...
	                		<input class="form-control" type="text" name="tgl_kembali" placeholder="Masukan Tanggal Kembali Barang" value="<?php echo $res['tgl_kembali'] ?>">               
	                	</div>             
